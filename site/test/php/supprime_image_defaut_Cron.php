...
function supprimeImage_CRON($debut, $fin){
	...
	if($jourSemaine>7){
		...
		$sql = mysql_query("SELECT * FROM `infoimage` WHERE `date` <= '".$anneeSemaine."-".$moisSemaine."-".$jourSemaine."' LIMIT ".$debut.",".$fin."");  // LIMIT ".$_POST["debut"].",".$_POST["nbLigneBDD"]
		if (!$sql) {
